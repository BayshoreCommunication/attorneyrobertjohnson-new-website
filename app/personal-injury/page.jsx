...
export const metadata = {
  title: "Personal Injury - Attorney Robert Johnson",
...
const PersonInjuryPage = () => {
  const data = [
    ...
    },
    {
      ...
      title: "Slip & Fall",
      text: [
        "An unexpected fall to a hard surface can cause significant injuries to a person’s body, bringing about medical bills, pain, suffering, and loss of the ability to earn a living. If you’ve slipped and fallen, or tripped and fallen, on someone else’s property, you may be entitled to financial compensation if you can prove that the property owner somehow failed to inspect the property or maintain it in a reasonably safe condition.",
            ...
            <div className="flex flex-col items-center gap-3 text-white">
              ...
              <MotionEffect effect={"fade-left"} duration={1500}>
                <div className="text-center hidden sm:block">
                  ...
                  <p>
                    He is not afraid to fight for justice for you and your
                    family.
                  </p>
                </div>
              </MotionEffect>
              ...
              <MotionEffect effect={"fade-up"} duration={1500}>
                <Link
                  ...
                  className="flex justify-center items-center gap-1 bg-white px-6 py-2 mt-2 rounded-md text-[#4b93ff] font-bold mx-auto text-lg"
                >
